              ...
              @csrf
                <div class="form-group">
                  ...
                  <div class="input-group">
                    ...
                    id="email" name="email" placeholder="correo@ejemplo.com" :value="old('email')">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="my-3">
                <button class="btn btn-block btn-primary btn-lg font-weight-medium auth-form-btn">Ingresar
                  </button>
                </div>
                ...
                ¿No tienes una cuenta? <a href="/register" class="text-primary">Crear</a>
                </div>
              </form>
            </div>
          </div>
